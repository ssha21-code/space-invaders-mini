...
#define MY_GREEN CLITERAL(Color){91, 255, 0, 255}
...
public:
    ...
    void draw() {
        ...
        DrawText(hp_label, posX + (width / 2 - 10), posY, 30, BLACK);
    }
    Rectangle getRectangle() {
...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        DrawText(hp_label, 25, 80, 36, BLACK);
